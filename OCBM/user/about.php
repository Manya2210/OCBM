            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <p>We Believe to Fulfill Your wishes to buy your <em>Dream car</em></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" id="tabs">
              ...
              <div class="col-lg-8">
                ...
                <section class='tabs-content'>
                    ...
                    <article id='tabs-1'>
                    <img src="../admin/aboutimage/<?php echo $row['doc']; ?>">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <p>Feel Free to send us a message we our available to help you 24*7</p>
