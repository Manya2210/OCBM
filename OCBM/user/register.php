...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($numExistRows > 0){
        ...
        $sql = "INSERT INTO `customers` (`role_id`,`customer_name`, `customer_phone`, `customer_address`, `customer_email`, `customer_password`, `deleted`) VALUES ('2','$name', '$phone', '$addr', '$email', '$hash', '0')";
