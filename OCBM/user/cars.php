            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <p>There are so Many Cars For You And Now You can buy your dream car easily</p>
                    </div>
                </div>
            </div>
        </div>
...
<br>
                            ...
                            <ul class="social-icons">
                                <li><a href="seemodel.php?carId=<?php echo $rows['car_id']; ?>">+ View <?php echo $rows['car_name'];?> Car Model</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
